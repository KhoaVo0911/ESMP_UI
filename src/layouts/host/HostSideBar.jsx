...
//     } else if (location.pathname.startsWith(`/package-trans`)) {
      ...
      children: [
        {
          ...
          onClick: () => {
            // Điều hướng đến Settings và truyền `hostId` vào URL
            navigate(`/settings/${hostId}`);
          },
        },
        {
          key: "6",
          ...
          onClick={(e) => {
            ...
            switch (e.key) {
              ...
              case "4":
                ...
                break;
              case "5":
                navigate(`/settings/${hostId}`); // Điều hướng đến Settings với hostId
                break;
              case "6":
                navigate("/packages");
                break;
