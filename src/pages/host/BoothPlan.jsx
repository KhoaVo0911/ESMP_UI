...
import { ref, uploadBytes, getDownloadURL } from "firebase/storage";
import { height } from "@mui/system";
import Add5BoothsModal from "../../components/host/booth/Add5BoothsModal";
...
const BoothPlan = () => {
  ...
  const [isAdd5BoothsModalOpen, setIsAdd5BoothsModalOpen] = useState(false);
  const [locationTypes, setLocationTypes] = useState([]);
  const [selectedElement, setSelectedElement] = useState(null);
  const [selectedBoothId, setSelectedBoothId] = useState(null);
  const [selectedShape, setSelectedShape] = useState(null);
  ...
  const handleAdd5Booths = (newBooths) => {
    ...
    <Flex direction="column" height="100vh">
      ...
      <Flex flex="1">
        ...
        <Sidebar
          setMode={setSelectedMode}
          openBoothModal={() => setIsBoothModalOpen(true)}
          openAdd5BoothsModal={() => setIsAdd5BoothsModalOpen(true)} // Open Add 5 Booths Modal
          addBooth={handleAddBooth}
          addText={addText}
          addShape={handleAddShape}
          addImage={handleImageButtonClick}
