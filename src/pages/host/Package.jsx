...
const CourseList = () => {
            ...
            axios
              ...
              .then(() => {
                toast({
                  ...
                  description: "The transaction has been canceled due to timeout.",
                  status: "info",
                  duration: 5000,
                  isClosable: true,
                });
  ...
  const checkPaid = async (
      ...
      if (
        ...
        if (hostId) {
          ...
          try {
                ...
                const updateHostData = async (
                  ...
                  try {
                    ...
                    toast({
                      ...
                      description:
                        "Ngày hết hạn và thời gian lưu trữ đã được cập nhật.",
                      status: "success",
                      duration: 5000,
                      isClosable: true,
                    });
                    ...
                    toast({
                      ...
                      description:
                        "Không thể cập nhật thông tin host. Vui lòng thử lại.",
                      status: "error",
                      duration: 5000,
                      isClosable: true,
                    });
            ...
            console.error(
              "Lỗi khi lấy thông tin giao dịch hoặc cập nhật host:",
              error
            );
            toast({
              title: "Lỗi",
    ...
    toast({
      title: "Lỗi",
      description: "Không thể kiểm tra trạng thái thanh toán. Vui lòng thử lại.",
      status: "error",
      duration: 5000,
      isClosable: true,
    });
